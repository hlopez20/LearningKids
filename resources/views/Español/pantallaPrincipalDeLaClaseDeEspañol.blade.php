...
<head>
  ...
  <title>Pantalla de español</title>
    <style>
        .navbar{
            background: #3B5686;
        }
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="http://learningkids.test/pantallaEspa%C3%B1ol">Ciencias Naturales</a></li>
...
<div class="container-fluid" style="background: #bce0ee">
    ...
    <div class="row pb-5">
        <div class="col-md-4">
            <a href="http://learningkids.test/chistes">
    ...
    <div class="row">
        <div class="col-md-4">
            <a href="http://learningkids.test/adivinanzas#">
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="http://learningkids.test/refranes">
        ...
        <div class="col-md-6">
            <a href="http://learningkids.test/trabalenguas">
