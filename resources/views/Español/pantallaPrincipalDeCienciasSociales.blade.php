...
<div class="container-fluid">
    ...
    <div class="container-fluid"style="background: #B8DA97">
        <div class="row">
            ...
            <div class="col-md-4">
                <img alt="Vista previa de la imagen de Bootstrap" src="https://i.ibb.co/h8Q1q6D/doc5.jpg"  class="rounded-circle mx-auto d-block bg-info"width="150"><h3>Los Derechos y<br> deberes de los niños</h3>
            </div>
        </div>
    </div>
    <div class="container-fluid" style="background: #B8DA97">
